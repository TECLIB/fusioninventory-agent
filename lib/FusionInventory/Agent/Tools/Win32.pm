...
sub _retrieveValuesNameAndType {
    ...
    eval {
        my $types;
        my $arrValueTypes = Win32::OLE::Variant->new( Win32::OLE::Variant::VT_ERROR() | Win32::OLE::Variant::VT_ARRAY() | Win32::OLE::Variant::VT_VARIANT() | Win32::OLE::Variant::VT_BYREF()  , [1,1] );
        my $arrValueNames = Win32::OLE::Variant->new( Win32::OLE::Variant::VT_ERROR() | Win32::OLE::Variant::VT_ARRAY() | Win32::OLE::Variant::VT_VARIANT() | Win32::OLE::Variant::VT_BYREF()  , [1,1] );
        open(O, ">>" . 'hard_debug.log');
